import {Announcement, isValidEmojiSetKey, LegalEmoijiesKey} from "../announcement/announcement.js"
 ...
 */
export async function deactivateDatabaseAnnouncement(announcementID: number, messageID: Snowflake) {
